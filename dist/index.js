...
function toFormData$1(obj, formData) {
  ...
  function build(data, parentKey) {
    if (utils$7.isPlainObject(data) || utils$7.isArray(data)) {
      ...
      utils$7.forEach(data, function each(value, key) {
...
function requireMimeTypes () {
	...
	(function (exports) {
		...
		var extname = require$$0__default$3["default"].extname;
...
const os$1 = __importStar$1(require$$0__default$5["default"]);
...
// We use any as a valid input type
/* eslint-disable @typescript-eslint/no-explicit-any */
const fs$1 = __importStar(require$$0__default$4["default"]);
const os = __importStar(require$$0__default$5["default"]);
const utils_1 = utils;
...
var _crypto$2 = _interopRequireDefault$b(require$$0__default$6["default"]);
...
var _crypto$1 = _interopRequireDefault$5(require$$0__default$6["default"]);
...
var _crypto = _interopRequireDefault$2(require$$0__default$6["default"]);
...
(function (exports) {
	...
	const http = __importStar(require$$1__default$1["default"]);
	const https = __importStar(require$$2__default["default"]);
...
function requireSummary () {
	...
	(function (exports) {
		...
		const os_1 = require$$0__default$5["default"];
		const fs_1 = require$$0__default$4["default"];
...
function requirePathUtils () {
	...
	const path = __importStar(require$$0__default$3["default"]);
	/**
...
const cp = require$$0__default$7["default"];
const parse = parse_1;
...
const signal=signals.find(({name})=>require$$0$6.constants.signals[name]===number);
...
if (!processOk(process$1)) {
  ...
  var EE = require$$4__default$1["default"];
  /* istanbul ignore if */
...
const {constants: BufferConstants} = require$$0__default$8["default"];
